...
def _convert(data):
    if isinstance(data, basestring):
        ...
        return data
# Create a class that will give us an object that we can use to connect to
# a database
...
# This is the module method to be called by the user in server.py. Make
# sure to provide the db name!
